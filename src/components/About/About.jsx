import { Container, Typography, CardMedia, Paper } from '@material-ui/core';
...
const About = () => {
    ...
    return (
        <Paper style={{padding: '20px', margin: '64px auto 0', maxWidth: '800px'}} id="tekijät">
